...
//  @file:  updateworker.h
// 
//  @brief:  This implements the worker for Updates, please take a look of the worker framework
//  description
// 
//  @version:  1.0
...
// =====================================================================================
#ifndef UPDATEWORKER_INCLUDED_H
#define UPDATEWORKER_INCLUDED_H 
...
class UpdateWorker: public Worker {
	public:
		UpdateWorker(Command* command, InputStream* input, OutputStream* output);
		UpdateWorker(const UpdateWorker& orig);
		...
		/**
		 * @brief Implements the Chain of responsability, at this moment Update does not require
