...
//  @file:  insertworker.h
// 
//  @brief:  This implements the worker for Inserts, please take a look of the worker framework
//  description
// 
//  @version:  1.0
...
// =====================================================================================
#ifndef INSERTWORKER_INCLUDED_H
#define INSERTWORKER_INCLUDED_H 
...
class InsertWorker: public Worker {
	public:
		InsertWorker(Command* command, InputStream* input, OutputStream* output);
		InsertWorker(const InsertWorker& orig);
		...
		/**
		 * @brief Implements the Chain of responsability, at this moment Insert does not require
	...
	private:
		InsertCommand* _command;
		InputStream* _input;
		OutputStream* _output;
};
#endif /* INSERTWORKER_INCLUDED_H */
