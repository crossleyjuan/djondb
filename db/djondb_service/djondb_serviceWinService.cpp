// djondb_service.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "djondb_serviceWinService.h"

using namespace djondb_service;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "djondb_service.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew djondb_serviceWinService());
	}
}
