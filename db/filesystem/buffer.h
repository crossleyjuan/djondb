...
#ifndef BUFFER_INCLUDED_H
#define BUFFER_INCLUDED_H
...
class Buffer: public InputOutputStream {
    public:
        Buffer(const BufferManager* manager, const char* fileName, __int64 offset, __int64 bufferLen, __int64 maxLength);
        ...
        virtual __int64 readLong ();
		  ...
		  void reset();
		  __int32 spaceLeft() const;

		  __int32 bufferIndex() const;
		  void setBufferIndex(__int32 index);
	 ...
	 private:
		  ...
		  __int32 _bufferIndex;                     /* Position within the buffermanager */
		  BufferManager* _manager;
		  std::string* _fileName;
		  Lock* _lock;
};

#endif // BUFFER_INCLUDED_H
